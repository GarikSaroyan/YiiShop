...
//ModelName::find() ->where(['between', 'date', "2014-12-31", "2015-02-31" ])->all();
                ...
                <div class="col-xl-9 stretch-card grid-margin ml-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="flotChartH5">Naxord shabatva ekamut</h5>
                            <?php
                            $storeId = \app\models\OrderItems::find()->select(['storeId'])->asArray()->all();
                            $storeIdNew = [];
